...
export function maskAadhaar(aadhaarNumber) {
  // Your code here
  if (typeof(aadhaarNumber) !== "string" || aadhaarNumber.length !== 12 || !/[0-9]/.test(aadhaarNumber) || /[a-zA-Z]/.test(aadhaarNumber)) return "INVALID"
  return "XXXX-".repeat(2) + aadhaarNumber.slice(8)
}